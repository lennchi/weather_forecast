...
if place:
    try:
        ...
        st.markdown("<p style='text-align: center; font-size: 40px'>Oh no!</p>", unsafe_allow_html=True)
        st.markdown("<p style='text-align: center; font-size: 26px'>We can't find this place. Please check the "
                    "spelling.",
